...
use crate::{MergedInteraction, complete_backend, cancel_backend, cancel_withdraw_backend, withdraw_backend, complete_withdraw_backend};
                    ...
                    if interaction.data.custom_id.starts_with("withdraw_cancel") {
                        ...
                        interaction.create_interaction_response(&ctx.http, |r| {
                            ...
                            .interaction_response_data(|d| {
                                d.content("Withdrawal process")
                                .custom_id("item_id")
                                .title("What is the id of the item you created ?")
                                .components(|c| {
                                    c.create_action_row(|r| r.create_input_text(|i| {
                                        i.custom_id("id")
                                        .label("Item ID")
